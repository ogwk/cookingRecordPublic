...
import 'package:cooking_record/page/record/record_view_model.dart';
...
class _RecordPageState extends State<RecordPage> {
  ...
  final RecordViewModel viewModel = RecordViewModel();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        heroTag: "hero1", // HeroTag設定（エラー回避のため）
        onPressed: () async {
  ...
  Widget localImageWidget() {
    return Container(
      ...
      child: GestureDetector(
          ...
          child: imageBox(200.0, 200.0, viewModel.imgFilePath)),
    );
  }
}
